 ...
 * @author kimura
 */
public class TwitterJsonConsolePrintTopology extends BaseTopology
{
    /**
     * コンストラクタ
     * 
     ...
     */
    public TwitterJsonConsolePrintTopology(String topologyName, Config config)
    {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (args.length < 2)
        {
            System.out.println("Usage: java JsonConsolePrintTopology ConfigPath isExecuteLocal(true|false)");
            return;
        }
    ...
    public void buildTopology() throws Exception
    {
        ...
        getBuilder().setBolt("ConsolePrintBolt", bolt, consoleBoltPara).localOrShuffleGrouping(
                "ConvertBolt");

 ...
 * <li>RedisBoltにて共通メッセージをRedisに投入する</li>
 * </ol>
 * 
 * yamlファイルから読み込む設定値
 * <ul>
 ...
 * <li>RedisBolt.RedisHost : Redisの投入先(デフォルト値:localhost)</li>
 * <li>RedisBolt.Parallelism : BlackHoleBoltの並列度(デフォルト値:1)</li>
 * </ul>
 * @author kimura
 */
public class Snmp2RedisTopology extends BaseTopology
{
    /**
     * コンストラクタ
     * 
     ...
     */
    public Snmp2RedisTopology(String topologyName, Config config)
    {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (args.length < 2)
        {
            System.out.println("Usage: java acromusashi.stream.example.topology.Snmp2RedisTopology ConfigPath isExecuteLocal(true|false)");
            return;
        }
        ...
        // Topologyを起動する
        BaseTopology topology = new Snmp2RedisTopology("Snmp2RedisTopology", conf);
    ...
    public void buildTopology() throws Exception
    {
        ...
        getBuilder().setBolt("RedisBolt", bolt, redisBoltPara).localOrShuffleGrouping("ConvertBolt");
